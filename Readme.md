...
The course description, learning goals, format, and outline with links to all activities can be found at the [course website](https://eds-217-essential-python.github.io).
